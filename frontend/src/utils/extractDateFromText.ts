 ...
 * Handles many different date formats and returns normalized YYYY-MM format
 */
...
/**
 * Validates that a string matches the normalized YYYY-MM format
 */
 ...
 *
 * Examples:
 * - "Trial balance report (Aug'24)" -> "2024-08"
 * - "Trial balance report (Sep'24)" -> "2024-09"
 * - "Report for 2024-08" -> "2024-08"
 * - "August 2025 Report" -> "2025-08"
 * - "TB_Jan_2024" -> "2024-01"
 * - "2025-08-15 Export" -> "2025-08"
 */
